...
from children import get_projected_windows
...
file_3 = pathlib.Path("D:\simulation\ifc\Single family house.IFC")
file_4 = pathlib.Path("D:\simulation\ifc\BEM_Example_ArchiCAD.ifc")
file_path = file_4
