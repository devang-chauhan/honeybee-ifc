...
for wall, shape in wall_shapes:
    ...
    while exp.More():
        ...
        if plane.Axis().Direction().Z() == 0:
            ...
            face_center = ifcopenshell.geom.utils.get_bounding_box_center(
                face_bbox).XYZ()
...
common_shape = OCC.Core.BRepPrimAPI.BRepPrimAPI_MakeBox(
    OCC.Core.gp.gp_Pnt(-10, -10, 0), OCC.Core.gp.gp_Pnt(10, 10, 10)).Solid()
for halfspace in halfspaces:
    common_shape = OCC.Core.BRepAlgoAPI.BRepAlgoAPI_Common(
